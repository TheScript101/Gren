...
local function createToggle(parent, sectionName)
	...
	toggle.TextSize = 12
	toggle.Text = "Auto Use When In Lobby: OFF"
	toggle.Parent = parent
	makeCorner(toggle, 7)

	toggle.MouseButton1Click:Connect(function()
		autoUse[sectionName] = not autoUse[sectionName]
		toggle.Text = "Auto Use When In Lobby: " .. (autoUse[sectionName] and "ON" or "OFF")
	end)
end
