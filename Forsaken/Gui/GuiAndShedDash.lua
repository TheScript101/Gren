...
local targetAnims = {
    -- Shedletsky
    ["rbxassetid://116618003477002"] = { dashDelay = dashDelay, dashDistance = 3.8},
    ["rbxassetid://121781457295101"] = { dashDelay = 0.15, dashDistance = 0.2},
  -- Skin SShedletsk
    ["rbxassetid://119462383658044"] = { dashDelay = dashDelay, dashDistance = 3.8 },

    -- Two Time
    ["rbxassetid://86545133269813"] = { dashDelay = 0.05, dashDistance = 6 },

    -- Noob
    ["rbxassetid://124033675853489"] = { dashDelay = 0.15, dashDistance = 8 },
    ["rbxassetid://96771054624545"] = { dashDelay = 0.15, dashDistance = 8 },
}
