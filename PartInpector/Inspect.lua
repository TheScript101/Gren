...
local function colorToRGBInts(color)
    -- returns three integers 0..255
...
local function colorToRGBString(color)
    local r,g,b = colorToRGBInts(color)
...
UserInputService.InputBegan:Connect(function(input, processed)
	...
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		if target and target:IsA("BasePart") then
			...
			colorBox.Text = colorToRGBString(selectedPart.Color) .. "  " .. colorToHex(selectedPart.Color)
